...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('/public/assets/ganttChart/dhtmlxgantt.css') }}">
@endsection
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('/public/assets/ganttChart/dhtmlxgantt.js') }}"></script>
