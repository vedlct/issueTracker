                    ...
                    <div class="col-lg-5 col-md-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="text-muted text-center font-18"><b>Request for an account</b></h4>
                                <div class="p-2">
                                    <form class="form-horizontal m-t-20" action="{{ route('insert.joinRequest') }}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <input class="form-control" type="text" name="url" placeholder="Company URL">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-12">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <textarea class="form-control" name="additionalInfo"  rows="3" placeholder="Additional Information"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group text-center row m-t-20">
                                            <div class="col-12">
                                                <button class="btn btn-primary btn-block waves-effect waves-light" type="submit">Send Request</button>
                                            </div>
                                        </div>
                                        <div class="form-group m-t-10 mb-0 row">
                                            ...
                                            <div class="col-sm-5 m-t-20"><a href="{{ route('index') }}" class="text-muted pull-right mr-2"><i class="mdi mdi-account-circle"></i> Sign in </a></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
