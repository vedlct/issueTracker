    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header bg-dark text-white custom-2">
                ...
                <?php if($employee->fk_userTypeId==3): ?>
                    <a href="<?php echo e(url('/employee-make-manager/'.$employee->userId)); ?>" class="btn btn-success pull-right" style="color: #0a1832">Make Manager</a>
                <?php elseif($employee->fk_userTypeId==5): ?>
                    <a href="<?php echo e(url('/employee-remove-manager/'.$employee->userId)); ?>" class="btn btn-danger pull-right" style="color: #0a1832">Remove Manager</a>
                <?php endif; ?>
            </div>
