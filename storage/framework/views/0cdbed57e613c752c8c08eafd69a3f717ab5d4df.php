                ...
                <?php if(Auth::user()->fk_userTypeId == 1): ?>
                    ...
                    <div class="col-lg-2 col-md-6 mb-2">
                        <div class="card newCard">
                            <div class="card-body">
                                <h5 class="card-title"><a href="<?php echo e(route('company.showAllCompany')); ?>">No. of Company</a></h5>
                                <div class="text-right">
                                    <h4 class="font-light m-b-0"> <?php echo e($companyCount); ?> </h4>
                                </div>
                ...
                <div class="col-lg-2 col-md-6 mb-2">
                    <div class="card newCard">
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                <h4 class="font-light m-b-0"> <?php echo e($projectCount); ?> </h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-6 mb-2">
                    <div class="card newCard">
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                <h4 class="font-light m-b-0"> <?php echo e($openticket); ?> </h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-6 mb-2">
                    <div class="card newCard">
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                <h4 class="font-light m-b-0"> <?php echo e($close); ?> </h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-6 mb-2">
                    <div class="card newCard">
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                <h4 class="font-light m-b-0"> <?php echo e($overdue); ?> </h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-6 mb-2">
                    <div class="card newCard">
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                <h4 class="font-light m-b-0"> <?php echo e($openticketMonth); ?> </h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-6 mb-2">
                    <div class="card newCard">
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                <h4 class="font-light m-b-0"> <?php echo e($closeMonth); ?> </h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-6 mb-2">
                    <div class="card newCard">
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                <h4 class="font-light m-b-0"> <?php echo e($overdueMonth); ?> </h4>
                            </div>
                        </div>
                    </div>
                </div>
