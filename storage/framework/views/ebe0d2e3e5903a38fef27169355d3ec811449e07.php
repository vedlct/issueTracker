    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header bg-dark text-white custom-2">
                <h4 class="float-left font-weight-normal">Add Company Admin</h4>
            </div>

            <div class="card-body">

                <div class="">
                    <form method="post" action="<?php echo e(route('company.admin.insert')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <button type="submit" class="btn btn-primary">Add Company Admin</button>
                    </form>
                </div>
            </div>
        </div>
