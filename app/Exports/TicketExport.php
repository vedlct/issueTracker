...
class TicketExport implements FromView
{
    ...
    public function view(): View
    {
        return view('Ticket.export_ticket', [
            ...
            'allTicket' =>  Ticket::select(DB::raw("GROUP_CONCAT(user.fullName) as assignTeamMembers"),'ticket.*','createdUser.fullName as createdFullName','assignUser.fullName as assignFullName')
