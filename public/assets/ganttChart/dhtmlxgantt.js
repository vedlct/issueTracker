...
!function (t, e) {
    ...
    return function (t) {
        ...
        var n = i(0), r = i(4), a = i(1), o = function () {
            "use strict";

            function t(t, e, i, o) {
                t && (this.$container = a.toNode(t), this.$parent = t), this.$config = n.mixin(e, {headerHeight: 33}), this.$gantt = o, this.$domEvents = o._createDomEventScope(), this.$id = e.id || "c" + n.uid(), this.$name = "cell", this.$factory = i, r(this)
            }
        ...
        var n = i(25), r = i(4), a = i(0), o = i(24), s = i(115), l = function (t, e, i, o) {
            this.$config = a.mixin({}, e || {}), this.$scaleHelper = new n(o), this.$gantt = o, r(this)
        };

        function c(t, e) {
            for (var i, n, r, a = 0, o = t.length - 1; a <= o;) if (n = +t[i = Math.floor((a + o) / 2)], r = +t[i - 1], n < e) a = i + 1; else {
                if (!(n > e)) {
                    for (; +t[i] == +t[i + 1];) i++;
                    return i
                }
        ...
        l.prototype = {
            init: function (t) {
                ...
                i && (this._staticBgHandler = i.attachEvent("onStoreUpdated", function (i, n, r) {
                    if (null === i && t.isVisible()) {
                        ...
                        if (a.static_background) {
                            ...
                            o && e.render(t.$task_bg, a, t.getScale(), a.row_height * o.countVisible())
                        }
                    }
                ...
                var n = this.$getConfig(), r = this.$gantt.$services.templates(), a = [], o = null, s = null, l = null;
                (t.template || t.date) && (s = t.template || this.$gantt.date.date_to_str(t.date));
                var u = 0, d = t.count;
                ...
                for (var h = u; h < d && t.trace_x[h]; h++) {
                    ...
                    var f = s.call(this, o), _ = t.width[h], g = t.height, p = t.left[h], v = "", m = "", y = "";
                    if (_) {
                        v = "width:" + _ + "px;height:" + g + "px;" + (n.smart_scales ? "position:absolute;left:" + p + "px" : ""), y = "gantt_scale_cell" + (h == t.count - 1 ? " gantt_last_cell" : ""), (m = l.call(this, o)) && (y += " " + m);
                ...
                var a = c(i, e), o = this._getClosestVisibleColumn(a, i, n), s = i[o],
        ...
        }, a.mixin(l.prototype, o()), t.exports = l
    }, function (t, e) {
        var i;
        i = function () {
            return this
        ...
        var n = i(20), r = i(0), a = i(4), o = function (t) {
        ...
        var n = i(1), r = i(0), a = i(4), o = i(114), s = i(24), l = function (t, e, i, n) {
        ...
        l.prototype = {
            init: function (t) {
                ...
                for (o = e + 1; o < n.length; o++) {
                    var u = n[o], d = Math.round(l * (u.width / r));
                ...
                getRowTop: function (t) {
                    ...
                    if (this.$config.rowStore) {
                        ...
                        if (-1 === i && e.getParent && e.exists(t)) {
                            ...
                            if (e.exists(n)) {
                                var r = e.getItem(n);
                                if (this.$gantt.isSplitTask(r)) return this.getRowTop(e.getIndexById(r.id))
                            }
                        }
        ...
        t.exports = function (t) {
            ...
            return {
                getSum: function (t, e, i) {
                    ...
                    var o = i.length - 1, s = i[o], l = e.add(s, t.step, t.unit);
        ...
        var n = i(2), r = i(1), a = function (t) {
            ...
            return n(e, t), e.prototype.destructor = function () {
                ...
                if (t.length) for (var i = t[0].$parent._xLayout ? "width" : "height", n = t[0].$parent.getNextSibling(t[0].$id) ? 1 : -1, r = 0; r < t.length; r++) {
                    ...
                    var s = o.getSize();
                    if (o[i]) {
                        var l = a.gravity + s.gravity, c = a[i] + s[i], u = l / c;
                ...
                for (var o = 0; o < this._sizes.length; o++) if (!(n = this.$cells[o]).$config.hidden) {
                ...
                for (o = 0; o < this._sizes.length; o++) if (!(n = this.$cells[o]).$config.hidden) {
                    var u = (r = this._sizes[o]).width, d = r.height;
                    this._xLayout ? this._calcFreeSpace(u, r, !0) : this._calcFreeSpace(d, r, !1)
                }
                for (o = 0; o < this.$cells.length; o++) if (!(n = this.$cells[o]).$config.hidden) {
                    r = this._sizes[o];
        ...
        t.exports = function (t) {
            ...
            t.assert = i(30)(t), t.init = function (t, e, i) {
                ...
                (i = []).push([t.$container, n[0], function (i) {
                    ...
                    if (!a(i)) {
                        ...
                        if (o && o.on_mouse_up(n), h && (t.refreshTask(t.locate(h)), h.parentNode && (h.parentNode.removeChild(h), t._touch_feedback())), t._touch_scroll_active = l = c = !1, h = null, u && s) {
                            var f = new Date;
                            if (f - s < 500) t.$services.getService("mouseEvents").onDoubleClick(u), _(i); else s = f
                        } else s = new Date
                    }
                }]);
        ...
        t.exports = function (t) {
            t._extend_to_optional = function (e) {
                var i = e, n = {
                    render: i.render, focus: i.focus, set_value: function (e, r, a, o) {
        ...
        t.exports = function (t) {
            ...
            return n(a, e), a.prototype.render = function (e) {
                var i = (e.height || 30) + "px",
                    n = "<div class='gantt_cal_ltext gantt_section_" + e.name + "' style='height:" + i + ";'>", a = [];
                ...
                a._eventsInitialized || (a.addEventListener("input", function (t) {
                    s(o, t.target.value)
                ...
                return o(s) || (l = t.form_blocks.getTimePickerValue(a, n)), {constraint_type: s, constraint_date: l}
            }, a.prototype.focus = function (e) {
        ...
        t.exports = function (t) {
            ...
            function a(e, i) {
                ...
                for (var a = e.template || t.templates.task_text, o = 0; o < n.length; o++) {
                    ...
                    void 0 === s && (s = ""), r.push({key: n[o].id, label: s})
                }
        ...
        t.exports = function (t) {
            ...
            function a(e, i) {
                var n = e.getElementsByTagName("select"), r = i._time_format_order, a = 0, o = 0;
                if (t.defined(r[3])) {
            ...
            return n(r, e), r.prototype.render = function (e) {
                ...
                var s, l, c, u, d = r, h = e.getElementsByTagName("select"), f = e.getElementsByTagName("input"),
                    _ = f[1], g = [f[0], f[2]], p = e.getElementsByTagName("span")[0], v = r._time_format_order;

                function m() {
                    var i = a.call(t, e, r), s = o.call(t, e, r),
                        l = t.calculateEndDate({start_date: i, duration: s, task: n});
                    p.innerHTML = t.templates.task_date(l)
                }

                function y(t) {
                    var e = _.value;
                    e = parseInt(e, 10), window.isNaN(e) && (e = 0), (e += t) < 1 && (e = 1), _.value = e, m()
                }
                ...
                g[0].onclick = t.bind(function () {
                ...
                }, this), _.onchange = t.bind(m, this), "string" == typeof (s = t._resolve_default_mapping(r)) && (s = {start_date: s}), l = n[s.start_date] || new Date, c = n[s.end_date] || t.calculateEndDate({
                    start_date: l,
                    duration: 1,
                    task: n
                    ...
                    end_date: c,
                    task: n
                }), t.form_blocks._fill_lightbox_select(h, 0, l, v, d), _.value = u, m()
            }, r.prototype.get_value = function (e, i, n) {
                var r = a(e, n), s = o(e), l = t.calculateEndDate({start_date: r, duration: s, task: i});
                return "string" == typeof t._resolve_default_mapping(n) ? r : {start_date: r, end_date: l, duration: s}
        ...
        t.exports = function (t) {
            ...
            return n(r, e), r.prototype.render = function (e) {
                ...
                var d = n[u.start_date] || new Date,
                    h = n[u.end_date] || t.calculateEndDate({start_date: d, duration: 1, task: n});
        ...
        t.exports = function (t) {
            var e = i(1), n = i(3), r = i(52)(t), a = i(51)(t), o = i(50)(t), s = i(8)(t), l = i(49)(t), c = i(48)(t),
                u = i(47)(t), d = i(46)(t), h = i(8)(t), f = i(45)(t);
            ...
            t._lightbox_methods = {}, t._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>", t.$services.getService("state").registerProvider("lightbox", function () {
                ...
                t.lightbox_events = {}, t.lightbox_events.gantt_save_btn = function () {
                    ...
                    if (n.getAttribute("data-dhx-button")) t.callEvent("onLightboxButton", [n.className, n, i]); else {
                        ...
                        if (-1 != o.indexOf("gantt_custom_button")) if (-1 != o.indexOf("gantt_custom_button_")) for (r = n.parentNode.getAttribute("data-index"), a = n; a && -1 == e.getClassName(a).indexOf("gantt_cal_lsection");) a = a.parentNode; else r = n.getAttribute("data-index"), a = n.parentNode, n = n.firstChild;
                ...
                for (var i = this._get_typed_lightbox_config(), n = 0; n < i.length; n++) {
                    ...
                    if (a) {
                        var o = a.get_value.call(this, r, e, i[n]), s = t._resolve_default_mapping(i[n]);
                ...
                for (var o = this._get_typed_lightbox_config(this.getLightboxType()), s = 0; s < o.length; s++) {
                    ...
                    if (this.form_blocks[l.type]) {
                        var c = document.getElementById(l.id).nextSibling, u = this.form_blocks[l.type],
                            d = t._resolve_default_mapping(o[s]), h = this.defined(n[d]) ? n[d] : l.default_value;
                ...
                if (this.getState().lightbox) {
                    ...
                    this.resetLightbox();
                    var a = this.mixin(r, n, !0), o = this.getLightbox(t || void 0);
                    this._center_lightbox(this.getLightbox()), this._set_lightbox_values(a, o)
        ...
        t.exports = function (t) {
            t.isUnscheduledTask = function (e) {
                ...
                if (n) r = t.config.schedule_from_end ? t.calculateEndDate({
                    ...
                    task: e
                }) : n.start_date; else if (t.config.schedule_from_end) r = t.calculateEndDate({
                ...
                if (e) {
                    var n = this.getTask(e), r = this.getParent(n), a = this._get_task_timing_mode(n), o = !0;
                    if (a.$no_start || a.$no_end) {
                        var s = n.start_date.valueOf(), l = n.end_date.valueOf();
                ...
                if (!i) return s;
                if (c == i.unit && l == i.step && +s >= +i.min_date && +s <= +i.max_date) o = Math.floor(t.columnIndexByDate(s)), i.trace_x[o] || (o -= 1, i.rtl && (o = 0)), a = new Date(i.trace_x[o]), r = t.date.add(a, l, c); else {
        ...
        i.prototype = {
            getWorkHours: function () {
                ...
                var t = this.argumentsHelper.getDurationArguments.apply(this.argumentsHelper, arguments),
                    e = t.start_date, i = t.end_date, n = t.unit, r = t.step;
                ...
                if (a[i]) o = Math.round((e - t) / (n * a[i])); else {
        ...
        a.prototype = {
            units: ["year", "month", "week", "day", "hour", "minute"], _getUnitOrder: function (t) {
                ...
                var l = this.$gantt.date.day_start(new Date(a)), c = a,
                    u = this._getWorkUnitsBetweenGeneric(o, s, i, n), d = this._getWorkUnitsBetweenGeneric(l, c, i, n);
                ...
                if (n = this.$gantt.date[e + "_start"](n), "any" != i && i) n = "past" == i ? this._getClosestWorkTimePast(n, e) : this._getClosestWorkTimeFuture(n, e); else {
                ...
                for (var n = this._getUnitOrder(e), r = this.units[n - 1], a = t, o = 0; !this._isWorkTime(a, e) && (!r || this._isWorkTime(a, r) || (a = this._getClosestWorkTimeGeneric(a, r, i), !this._isWorkTime(a, e)));) {
        ...
        o.prototype = {
            ...
            mergeCalendars: function () {
                ...
                for (var a = 0; a < n.length; a++) for (var o in n[a].worktime.dates) +o > 1e4 && (i = this._getDayHoursForMultiple(n, new Date(+o)), e.worktime.dates[o] = i);
                return e
            },
            ...
            createCalendar: function (t) {
                ...
                n.mixin(e, i);
                var o = {id: n.uid() + "", worktime: this._convertWorktimeSettings(e)},
                    s = new a(this.$gantt, r(this.$gantt));
                return n.mixin(s, o), s._tryChangeCalendarSettings(function () {
                }) ? s : null
            },
            ...
            getTaskCalendar: function (t) {
                ...
                var e = this._getOwnCalendar(t), i = this.$gantt;
        ...
        var n = i(62), r = i(57), a = i(55), o = i(0);
        t.exports = function (t) {
            var e = new n(t), i = new r(e), s = a.create(e, i);
            o.mixin(t, s)
        }
    }, function (t, e, i) {
        var n = i(3);
        t.exports = function (t) {
            t.load = function (e, i, n) {
                ...
                _xmlNodeToJSON: function (t, e) {
                    ...
                    for (var i = {}, n = t.ajax.xpath("//coll_options", e), r = 0; r < n.length; r++) for (var a = i[n[r].getAttribute("for")] = [], o = t.ajax.xpath(".//item", n[r]), s = 0; s < o.length; s++) {
                ...
                parse: function (e, i) {
                    ...
                    for (var n = {collections: {links: []}}, r = n.data = [], a = t.ajax.xpath("//task", i), o = 0; o < a.length; o++) {
        ...
        function r(t) {
            ...
            function r(i, r) {
                for (var a, o = r.join("_") + "_" + i, s = {}, l = 0; l < r.length; l++) s[r[l]] = !0;
                return e[o] ? a = e[o] : (a = e[o] = [], t.eachTask(function (e) {
                    var r;
                    e.type != t.config.types.project && (r = n.isArray(e[i]) ? e[i] : [e[i]], n.forEach(r, function (t) {
                        t && (s[t] || s[t.resource_id]) && a.push(e)
                    }))
                })), a
            }
            ...
            function a(n, r, a, o) {
                ...
                return e[s] ? e[s] : e[s] = function (e, n, r, a) {
                    g = "task" == e.$role ? [] : i(n, e.id);
                    for (var o = r.unit, s = {}, l = 0; l < g.length; l++) for (var c = g[l], u = t.date[o + "_start"](new Date(c.start_date)); u < c.end_date;) {
                        var d = u;
                        if (u = t.date.add(u, 1, o), t.isWorkTime({date: d, task: c, unit: o})) {
                            var h = d.valueOf();
                            s[h] || (s[h] = []), s[h].push(c)
                        }
                    }
                    for (var f, _, g, p = [], v = a.$getConfig(), l = 0; l < r.trace_x.length; l++) f = new Date(r.trace_x[l]), _ = t.date.add(f, 1, o), ((g = s[f.valueOf()] || []).length || v.resource_render_empty_cells) && p.push({
                        start_date: f,
                        end_date: _,
                        tasks: g
                    });
            ...
            function o(t, e, i, n) {
                var r = 100 * (1 - (1 * t || 0)), a = n.posFromDate(e), o = n.posFromDate(i),
            ...
            return t.$data.tasksStore.attachEvent("onStoreUpdated", function () {
                ...
                renderLine: function (t, e) {
                    for (var i = e.$getConfig(), n = e.$getTemplates(), r = a(t, i.resource_property, e.getScale(), e), o = [], s = 0; s < r.length; s++) {
                        var l = r[s], c = n.resource_cell_class(l.start_date, l.end_date, t, l.tasks),
                            u = n.resource_cell_value(l.start_date, l.end_date, t, l.tasks);
                        if (c || u) {
                            var d = e.getItemPosition(t, l.start_date, l.end_date), h = document.createElement("div");
                            h.className = ["gantt_resource_marker", c].join(" "), h.style.cssText = ["left:" + d.left + "px", "width:" + d.width + "px", "height:" + (i.row_height - 1) + "px", "line-height:" + (i.row_height - 1) + "px", "top:" + d.top + "px"].join(";"), u && (h.innerHTML = u), o.push(h)
                        }
                    }
                    var f = null;
                    if (o.length) for (f = document.createElement("div"), s = 0; s < o.length; s++) f.appendChild(o[s]);
                    return f
                }, renderHistogram: function (e, i) {
                    for (var n = i.$getConfig(), r = i.$getTemplates(), l = a(e, n.resource_property, i.getScale(), i), c = [], u = {}, d = e.capacity || i.$config.capacity || 24, h = 0; h < l.length; h++) {
                        var f = l[h], _ = r.histogram_cell_class(f.start_date, f.end_date, e, f.tasks),
                            g = r.histogram_cell_label(f.start_date, f.end_date, e, f.tasks),
                            p = r.histogram_cell_allocated(f.start_date, f.end_date, e, f.tasks),
                            v = r.histogram_cell_capacity(f.start_date, f.end_date, e, f.tasks);
                        if (u[f.start_date.valueOf()] = v || 0, _ || g) {
                            var m = i.getItemPosition(e, f.start_date, f.end_date), y = document.createElement("div");
                            y.className = ["gantt_histogram_cell", _].join(" "), y.style.cssText = ["left:" + m.left + "px", "width:" + m.width + "px", "height:" + (n.row_height - 1) + "px", "line-height:" + (n.row_height - 1) + "px", "top:" + (m.top + 1) + "px"].join(";"), g && (g = "<div class='gantt_histogram_label'>" + g + "</div>"), p && (g = "<div class='gantt_histogram_fill' style='height:" + 100 * Math.min(p / d || 0, 1) + "%;'></div>" + g), g && (y.innerHTML = g), c.push(y)
                        }
                    }
                    var b = null;
                    if (c.length) {
                        for (b = document.createElement("div"), h = 0; h < c.length; h++) b.appendChild(c[h]);
                        var k = function (e, i, n) {
                            for (var r = i.getScale(), a = document.createElement("div"), l = 0; l < r.trace_x.length; l++) {
                                ...
                                if (h < 0) return null;
                                var f = Math.min(e[u.valueOf()] / n, 1) || 0, _ = o(h, c, u, i);
                                _ && a.appendChild(_);
                                var g = s(h, f, i.posFromDate(u));
                                g && a.appendChild(g)
                            }
                            return a
                        }(u, i, d);
                        k && (k.setAttribute("data-resource-id", e.id), k.style.position = "absolute", k.style.top = m.top + 1 + "px", k.style.height = n.row_height - 1 + "px", k.style.left = 0, b.appendChild(k))
                    }
                    return b
                ...
                return {
                    _needRecalc: !0, reset: function () {
                        ...
                        for (var i = e.split("."), n = t.config.root_id, r = 0; r < i.length; r++) {
                            var a = t.getChildren(n), o = 1 * i[r] - 1;
        ...
        var n = i(1);
        t.exports = function (t) {
            var e = 50, i = 30, r = 10, a = 50, o = null, s = !1, l = null, c = {started: !1}, u = {};
            ...
            function f(t) {
                t ? (h(!0), c.started || (c.x = u.x, c.y = u.y, c.started = !0)) : (o && (clearInterval(o), o = null), h(!1), c.started = !1)
            }

            function _(e) {
                var i = d();
                if (!o && !l || i || f(!1), !t.config.autoscroll || !i) return !1;
                u = {x: e.clientX, y: e.clientY}, !o && i && f(!0)
            }

            function g() {
                if (!d()) return f(!1), !1;
                var e = n.getNodePosition(t.$task || t.$grid || t.$root), r = u.x - e.x, a = u.y - e.y,
                    o = s ? 0 : p(r, e.width, c.x - e.x), l = p(a, e.height, c.y - e.y), h = t.getScrollState(),
                    _ = h.y, g = h.inner_height, v = h.height, m = h.x, y = h.inner_width, b = h.width;
                l && !g ? l = 0 : l < 0 && !_ ? l = 0 : l > 0 && _ + g >= v + 2 && (l = 0), o && !y ? o = 0 : o < 0 && !m ? o = 0 : o > 0 && m + y >= b && (o = 0);
                var k = t.config.autoscroll_step;
                k && k < 2 && (k = 2), o *= k || i, l *= k || i, (o || l) && function (e, i) {
            ...
            t.attachEvent("onGanttReady", function () {
                t.eventRemove(document.body, "mousemove", _), t.event(document.body, "mousemove", _)
            })
        }
    }, function (t, e, i) {
        t.exports = function (t) {
            for (var e = [i(76), i(75), i(74), i(73), i(72), i(71), i(70), i(69)], n = 0; n < e.length; n++) e[n] && e[n](t)
        }
    }, function (t, e, i) {
        "use strict";
        ...
        var n = i(3), r = function () {
            ...
            return t.prototype.attach = function () {
                var t = this.$dp, e = this.$gantt, n = i(18), r = {};
                ...
                this._dataProcessorHandlers.push(e.attachEvent("onAfterTaskAdd", function (i, n) {
                    ...
                    if (t.setGanttMode("tasks"), !a(i)) {
                        if (e.config.cascade_delete && r[i]) {
                            ...
                            t.setUpdateMode("off");
                            var s = r[i];
                            for (var l in s.tasks) a(l) || t.setUpdated(l, !0, "deleted");
                            for (var l in t.setGanttMode("links"), s.links) a(l) || t.setUpdated(l, !0, "deleted");
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0});
        var n = i(4), r = i(3), a = i(0), o = i(79), s = i(78);
        ...
        var l = function () {
            ...
            return t.prototype.setTransactionMode = function (t, e) {
                ...
                if (!this._waitMode || "tree" !== this.$gantt.mytype && !this.$gantt._h2) {
                    if (this.$gantt.editStop && this.$gantt.editStop(), void 0 === t || this._tSend) return this.sendAllData();
                ...
                if (t) {
                    ...
                    if ("CUSTOM" !== this._tMode) {
                        ...
                        var a,
                            o = this.serverProcessor + (this._user ? n.urlSeparator(this.serverProcessor) + ["dhx_user=" + this._user, "dhx_version=" + this.$gantt.getUserData(0, "version")].join("&") : ""),
                        ...
                        switch (this._tMode) {
                            ...
                            case"POST":
                                ...
                                break;
                            case"JSON":
                                for (var l in a = {}, t) l !== this.action_param && "id" !== l && "gr_id" !== l && (a[l] = t[l]);
                    ...
                    var c = this.getState(e), u = this.getActionByState(c), d = this.getGanttMode(), h = function (t) {
                        var n = c || "updated", r = e, a = e;
                        t && (n = t.action || c, r = t.sid || r, a = t.id || t.tid || a), i.afterUpdateCallback(r, a, n, t)
                    }, f = void 0;
                    ...
                    if (this._tSend) this._sendData(this._getAllData()); else {
                        ...
                        this._forEachUpdatedRow(function (t) {
                            if (!e && !this._in_progress[t]) {
                                ...
                                this._beforeSendData(this._getRowData(t), t), this._waitMode && ("tree" === this.$gantt.mytype || this.$gantt._h2) && (e = !0)
                            }
                        })
                    }
                }
                ...
                switch (i) {
                    ...
                    case"delete":
                    case"deleted":
                        return this.$gantt.setUserData(t, this.action_param, "true_deleted"), this.$gantt[this._methods[3]](t), delete this._in_progress[r], this.callEvent("onAfterUpdate", [t, i, e, n])
                }
                "wait" !== this._in_progress[r] ? (a && this.$gantt.setUserData(t, this.action_param, ""), delete this._in_progress[r]) : (delete this._in_progress[r], this.setUpdated(e, !0, this.$gantt.getUserData(t, this.action_param))), this.callEvent("onAfterUpdate", [o, i, e, n])
            }, t.prototype.afterUpdate = function (t, e, i) {
                var n;
                n = 3 === arguments.length ? arguments[1] : arguments[4];
                var r = this.getGanttMode(), a = n.filePath || n.url;
                ...
                this._waitMode && this._waitMode--, ("tree" === this.$gantt.mytype || this.$gantt._h2) && this.updatedRows.length && this.sendData(), this.callEvent("onAfterUpdateFinish", []), this.updatedRows.length || this.callEvent("onFullSync", [])
                ...
                var t = this, e = this.$gantt.ajax, i = this.$gantt.getUserData(0, "version"),
                ...
                n || (n = e[t] = {
                    ...
                    _invalid: {},
                    updatedRows: []
                }), this._in_progress = n._in_progress, this._invalid = n._invalid, this.updatedRows = n.updatedRows, this.modes = e, this._ganttMode = t
            }, t.prototype.getGanttMode = function () {
                return this._ganttMode
            }, t.prototype._getRowData = function (t) {
                var e;
                e = "task" === this.getGanttMode() ? this.$gantt.isTaskExists(t) ? this.$gantt.getTask(t) : {id: t} : this.$gantt.isLinkExists(t) ? this.$gantt.getLink(t) : {id: t}, e = this.$gantt.copy(e);
                var i = {};
                for (var n in e) if ("$" !== n.substr(0, 1)) {
                    var a = e[n];
                    r.isDate(a) ? i[n] = this.$gantt.templates.xml_format(a) : i[n] = null === a ? "" : a
                }
                var o = this.$gantt._get_task_timing_mode(e);
                return o.$no_start && (e.start_date = "", e.duration = ""), o.$no_end && (e.end_date = "", e.duration = ""), i[this.action_param] = this.$gantt.getUserData(t, this.action_param), i
        ...
        t.exports = {
            bindDataStore: function (t, e) {
                ...
                i.attachEvent("onStoreUpdated", function (o, s, l) {
                    if (!a(e)) {
                        var c = e.$services.getService("layers").getDataRender(t);
                        c && (o && "move" != l && "delete" != l ? (i.callEvent("onBeforeRefreshItem", [s.id]), n(s.id, c), i.callEvent("onAfterRefreshItem", [s.id])) : (i.callEvent("onBeforeRefreshAll", []), r(c), i.callEvent("onAfterRefreshAll", [])))
                    }
                }), i.attachEvent("onItemOpen", function () {
                    e.render()
                }), i.attachEvent("onItemClose", function () {
                    e.render()
                }), i.attachEvent("onIdChange", function (r, o) {
                    if (i.callEvent("onBeforeIdChange", [r, o]), !a(e)) {
                        var s = e.$services.getService("layers").getDataRender(t);
                        !function (t, e, i, n) {
                            for (var r = 0; r < t.length; r++) t[r].change_id(e, i)
                        }(s.getLayers(), r, o, i.getItem(o)), n(o, s)
                    }
                })
            }
        }
        ...
        var n = i(20), r = i(0), a = i(21), o = function (t) {
        ...
        o.prototype = r.mixin({
            _buildTree: function (t) {
                ...
                if (t != i) {
                    i = i || this.$getRootId();
                    var r = this.getItem(t), a = this.getParent(r.id), o = this.getChildren(i);
                    if (-1 == e && (e = o.length + 1), a == i) if (this.getBranchIndex(t) == e) return;
        ...
        var n = i(0), r = i(86), a = i(85), o = i(21), s = i(84), l = i(83), c = i(82);
            ...
            var o = t.createDatastore({
                name: "task", type: "treeDatastore", rootId: function () {
                    ...
                    return (e.duration || 0 === e.duration) && (e.duration = i = 1 * e.duration), i && (e.start_date && !e.end_date ? e.end_date = this.calculateEndDate(e) : !e.start_date && e.end_date && (e.start_date = this.calculateEndDate({
                        ...
                        duration: -e.duration,
                        task: e
                    }))), e.progress = Number(e.progress) || 0, this._isAllowedUnscheduledTask(e) && this._set_default_task_timing(e), this._init_task_timing(e), e.start_date && e.end_date && this.correctTaskWorkTime(e), e.$source = [], e.$target = [], void 0 === e.parent && this.setParent(e, this.config.root_id), e
                }, t)
            }), s = t.createDatastore({
        ...
        t.exports = function () {
            ...
            return {
                getColumnIndex: function (t) {
                    ...
                    var n = this, o = a.call(n, t, "getRowTop", [i], function () {
                        return a.call(n, e, "getRowTop", [i])
                    });
                    return o === r ? 0 : o
                }, getTaskTop: function (i) {
                    var n = this, o = a.call(n, t, "getItemTop", [i], function () {
                    ...
                    var r = i(this), a = n(this), o = {position: 0}, s = {position: 0};
                ...
                getVerticalScrollbar: function () {
                    ...
                    if (n.resizer) {
                        ...
                        o.attachEvent("onResizeStart", function (e, i) {
                            var n = t.$ui.getView("grid"), o = n ? n.$parent : null;
                            if (o) {
                            ...
                            var o = a ? e : i, s = a ? n : r, l = t.$ui.getView("grid"), c = l ? l.$parent : null;
        ...
        var n = i(1), r = function (t, e) {
            ...
            function f(i, n, r, a, o) {
                var s = function (i, n, r) {
                    var a = n(i), o = {x: a.left, y: a.top, width: a.width, height: a.height};
            ...
            h.attachEvent("onBeforeDragStart", e.bind(function (i, r) {
                ...
                if (n.locateClassName(a, "gantt_link_point")) {
                    ...
                    o = l;
                    var c = e.getTask(l);
                    if (e.isReadonly(c)) return g(), !1;
                    return this._dir_start = f(c, !!s, 0, t.$getConfig(), !0), !0
                }
                return !1
            }, this)), h.attachEvent("onAfterDragStart", e.bind(function (t, i) {
                e.config.touch && e.refreshData(), _(h.config.marker)
            }, this)), h.attachEvent("onDragMove", e.bind(function (o, s) {
                var c = h.config, u = h.getPosition(s);
                !function (t, e) {
                    t.style.left = e.x + 5 + "px", t.style.top = e.y + 5 + "px"
                }(c.marker, u);
                var d = !!n.locateClassName(s, "gantt_link_control"), g = r, v = i, m = a, y = e.locate(s), b = !0;
                if (n.isChildOf(s.target || s.srcElement, e.$root) || (d = !1, y = null), d && (b = !n.locateClassName(s, "task_end_date"), d = !!y), r = y, i = d, a = b, d) {
                    var k = e.getTask(y), w = t.$getConfig(), x = n.locateClassName(s, "gantt_link_control"), $ = 0;
                    x && ($ = Math.floor(x.offsetWidth / 2)), this._dir_end = f(k, !!a, $, w)
                } else this._dir_end = n.getRelativeEventPosition(s, t.$task_data);
                var T = !(v == d && g == y && m == b);
                return T && (g && e.refreshTask(g, !1), y && e.refreshTask(y, !1)), T && _(c.marker), function (i, n, r, a) {
                    var o = function () {
                        h._direction || (h._direction = document.createElement("div"), t.$task_links.appendChild(h._direction));
                        return h._direction
                    }(), s = l(), c = ["gantt_link_direction"];
                    ...
                    var u = Math.sqrt(Math.pow(r - i, 2) + Math.pow(a - n, 2));
                    if (!(u = Math.max(0, u - 3))) return;
                    o.className = c.join(" ");
                    var d = (a - n) / (r - i), f = Math.atan(d);
                    2 == p(i, r, n, a) ? f += Math.PI : 3 == p(i, r, n, a) && (f -= Math.PI);
                    var _ = Math.sin(f), g = Math.cos(f), v = Math.round(n), m = Math.round(i),
                    ...
                    if (-1 != window.navigator.userAgent.indexOf("MSIE 8.0")) {
                        ...
                        var b = Math.abs(Math.round(i - r)), k = Math.abs(Math.round(a - n));
                        switch (p(i, r, n, a)) {
                            case 1:
                                v -= k;
                                break;
                    ...
                    y.push("top:" + v + "px"), y.push("left:" + m + "px"), o.style.cssText = y.join(";")
                ...
                g(), e.config.touch ? e.refreshData() : (t.link_source_id && e.refreshTask(t.link_source_id, !1), t.link_target_id && e.refreshTask(t.link_target_id, !1)), h._direction && (h._direction.parentNode && h._direction.parentNode.removeChild(h._direction), h._direction = null)
            }, this))
        };
        t.exports = {
                        ...
                        return t = function (t, e) {
                            ...
                            return {
                                ...
                                init: function () {
                                    ...
                                    for (var a in this._events) for (var o in t) this._events[a][o] = n[a];
                                ...
                                _resize: function (i, n, r) {
                                    var a = t.$getConfig(), o = this._drag_task_coords(i, r);
                                ...
                                _update_item_on_move: function (t, i, n, r, a) {
                                    var o = e.getTask(i), s = e.mixin({}, o), l = e.mixin({}, o);
                                    ...
                                    if (a.mode) {
                                        ...
                                        if (this._handlers[a.mode]) {
                                            if (e.isSummaryTask(u) && e.config.drag_project && a.mode == o.drag_mode.move) {
                                                ...
                                                for (var f in void 0 !== h && (c = h), this._update_item_on_move(c, a.id, a.mode, a, i), this.dragMultiple) {
                                ...
                                on_mouse_down: function (i, r) {
                                    if (2 != i.button || void 0 === i.button) {
                                        var a = t.$getConfig(), o = e.locate(i), s = null;
                                ...
                                on_mouse_up: function (i) {
                                    var n = this.drag;
                                    if (n.mode && n.id) {
                                        var r = t.$getConfig(), a = e.getTask(n.id), o = this.dragMultiple;
                                        if (e.isSummaryTask(a) && r.drag_project && n.mode == r.drag_mode.move) for (var s in o) this._finalize_mouse_up(o[s].id, r, o[s], i);
                                ...
                                _start_dnd: function (i) {
                                    ...
                                    if (r["drag_" + n.mode] && e.callEvent("onBeforeDrag", [a, n.mode, i]) && this._fireEvent("before_start", n.mode, [a, n.mode, i])) {
                                        ...
                                        }, o.id, this), e.callEvent("onTaskDragStart", [])
        ...
        var n = i(0), r = i(93), a = i(92), o = i(1), s = function (t) {
            var e = t.$services;
            return {
                onCreated: function (e) {
                    var o = e.$config;
                    o.bind = n.defined(o.bind) ? o.bind : "task", o.bindLinks = n.defined(o.bindLinks) ? o.bindLinks : "link", e._linksDnD = a.createLinkDND(), e._tasksDnD = r.createTaskDND(), e._tasksDnD.extend(e), this._mouseDelegates = i(10)(t)
                }, onInitialized: function (e) {
                    ...
                    this._mouseDelegates.delegate("click", "gantt_task_link", t.bind(function (t, e) {
                        ...
                        var n = o.getRelativeEventPosition(e, t.$task_data), r = t.dateFromPos(n.x),
            ...
            removeLineHighlight: function (t) {
                ...
                var a = function (t, e) {
                    var i = n.getNodePosition(e.$grid_data), r = n.getRelativeEventPosition(t, e.$grid_data),
                        a = e.$config.rowStore, o = i.x, s = r.y - 10, l = e.$getConfig();
                    s < i.y && (s = i.y);
                ...
                o || ((o = document.createElement("div")).className = "gantt_drag_marker gantt_grid_dnd_marker", o.innerHTML = "<div class='gantt_grid_dnd_marker_line'></div>", o.style.pointerEvents = "none", document.body.appendChild(o), e.markerLine = o), t.child ? function (t, e, i) {
                    ...
                    var n = function (t, e) {
                        var i = e.$config.rowStore, n = {x: 0, y: 0},
        ...
        t.exports = function (t, e, i, r, a) {
            var o;
            if (e !== a.$getRootId()) o = i < .25 ? n.prevSiblingTarget(t, e, a) : !(i > .6) || a.hasChild(e) && a.getItem(e).$open ? n.firstChildTarget(t, e, a) : n.nextSiblingTarget(t, e, a); else {
                var s = a.$getRootId();
        ...
        t.exports = function (t, e, i, r, s, l) {
            var c;
            if (e !== s.$getRootId()) i < .5 ? s.calculateItemLevel(s.getItem(e)) === l ? c = s.getPrevSibling(e) ? n.nextSiblingTarget(t, s.getPrevSibling(e), s) : n.prevSiblingTarget(t, e, s) : (c = a(t, e, l, s)) && (c = o(t, e, l, s)) : s.calculateItemLevel(s.getItem(e)) === l ? c = n.nextSiblingTarget(t, e, s) : (c = o(t, e, l, s)) && (c = a(t, e, l, s)); else {
        ...
        var n = i(1), r = i(9), a = i(97), o = i(96), s = i(95);
        t.exports = {
            init: function (t, e) {
            ...
            init: function (t, e) {
                ...
                if (e.$config.bind && t.getDatastore(e.$config.bind)) {
                    ...
                    t.defined(e.$getConfig().dnd_sensitivity) && (r.config.sensitivity = e.$getConfig().dnd_sensitivity), r.attachEvent("onBeforeDragStart", t.bind(function (i, s) {
                        ...
                        var i = n.getNodePosition(e.$grid_data), r = o(), a = i.x, s = t.pos.y - 10, l = e.$getConfig();
                        s < i.y && (s = i.y);
                        ...
                        var n = r.config, a = r._getGridPos(i), s = e.$getConfig(), l = o();
                        n.marker.style.left = a.x + 10 + "px", n.marker.style.top = a.y + "px";
                        var c = l.getItem(r.config.id), u = r._getTargetY(i),
        ...
        var n = i(0), r = i(99), a = i(98), o = function (t) {
            return {
                onCreated: function (e) {
        ...
        t.exports = function (t) {
            return function (e, i) {
                var r = i.getGridColumns(), a = i.$getConfig(), o = i.$getTemplates(), s = i.$config.rowStore;
                a.rtl && (r = r.reverse());
                for (var l = [], c = 0; c < r.length; c++) {
                    var u, d, h, f = c == r.length - 1, _ = r[c];
                    "add" == _.name ? (d = "<div " + (y = t._waiAria.gridAddButtonAttrString(_)) + " class='gantt_add'></div>", h = "") : (d = _.template ? _.template(e) : e[_.name], n.isDate(d) && (d = o.date_grid(d, e)), h = d, d = "<div class='gantt_tree_content'>" + d + "</div>");
                    var g = "gantt_cell" + (f ? " gantt_last_cell" : ""), p = [];
                    if (_.tree) {
                        for (var v = 0; v < e.$level; v++) p.push(o.grid_indent(e));
                        s.hasChild(e.id) && !t.isSplitTask(e) ? (p.push(o.grid_open(e)), p.push(o.grid_folder(e))) : (p.push(o.grid_blank(e)), p.push(o.grid_file(e)))
                    }
                    var m = "width:" + (_.width - (f ? 1 : 0)) + "px;";
                    this.defined(_.align) && (m += "text-align:" + _.align + ";");
                    var y = t._waiAria.gridCellAttrString(_, h);
                    p.push(d), a.rtl && (p = p.reverse()), u = "<div class='" + g + "' data-column-index='" + c + "' data-column-name='" + _.name + "' style='" + m + "' " + y + ">" + p.join("") + "</div>", l.push(u)
                }
                if (g = t.getGlobalTaskIndex(e.id) % 2 == 0 ? "" : " odd", g += e.$transparent ? " gantt_transparent" : "", g += e.$dataprocessor_class ? " " + e.$dataprocessor_class : "", o.grid_row_class) {
                    var b = o.grid_row_class.call(t, e.start_date, e.end_date, e);
                    b && (g += " " + b)
                }
                s.getSelectedId() == e.id && (g += " gantt_selected");
                var k = document.createElement("div");
                k.className = "gantt_row" + g + " gantt_row_" + t.getTaskType(e.type);
        ...
        t.exports = function (t) {
            ...
            function o(t, e, i) {
                for (var n = t.$target, r = [], a = 0; a < n.length; a++) {
                    var o = i.getLink(n[a]), s = i.getTask(o.source);
            ...
            return i(2)(r, e), n.mixin(r.prototype, {
                show: function (t, e, i, n) {
                    ...
                    var s = this.get_value(i, n, r), l = a(o(e, n.editor, t), n.editor);
        ...
        t.exports = function (t) {
            var e = i(6)(t), n = i(0), r = "%Y-%m-%d", a = null, o = null;
        ...
        t.exports = {
            init: function (t, e) {
                ...
                a.attachEvent("onBeforeFocus", function (e) {
                    ...
                    if (clearTimeout(r), n) {
                        var a = n.columnName, o = n.id, s = i.getState();
                    ...
                    switch (u) {
                        ...
                        case c.SPACE:
                            ...
                            break;
                        case c.DELETE:
                            s && !t.isVisible() && (i.startEdit(o.id, o.columnName), d = !0);
                            break;
                        case c.TAB:
                            if (t.isVisible()) {
        ...
        var n = i(112), r = i(109), a = i(108), o = i(107), s = i(106), l = i(105), c = i(0), u = i(1), d = i(4);
                ...
                init: h, createEditors: function (n) {
                    function r(t, e) {
                        var i = function (t, e) {
                            ...
                            return {top: i, left: o, height: r, width: s}
                    ...
                    var a = [], o = null, s = {
                        ...
                        init: function () {
                            var t = e.getMapping();
                            t.init && t.init(this, n), o = n.$gantt.getDatastore(n.$config.bind);
                            var i = this;
                            a.push(o.attachEvent("onIdChange", function (t, e) {
                                i._itemId == t && (i._itemId = e)
                            })), a.push(o.attachEvent("onStoreUpdated", function () {
                                n.$gantt.getState("batchUpdate").batch_update || i.isVisible() && !o.isVisible(i._itemId) && i.hide()
                            })), this.init = function () {
                            }
                        },
                        getState: function () {
                        ...
                        show: function (t, i) {
                            ...
                            var a = {id: t, columnName: i}, o = n.getColumn(a.columnName),
                                s = this.getEditorConfig(o.name);
                            if (s) {
                                var l = n.$getConfig().editor_types[s.type], c = r(a.id, a.columnName);
                        ...
                        save: function () {
                            if (this.isVisible() && o.exists(this._itemId) && this.isChanged()) {
                                ...
                                if (o.exists(e)) {
                                    var r = o.getItem(e), a = this.getEditorConfig(i), s = {
                                        id: e,
                                        columnName: i,
                                    ...
                                    if (!1 !== this.callEvent("onBeforeSave", [s]) && this._editor.is_valid(s.newValue, s.id, s.columnName, this._placeholder)) {
                                        ...
                                        "auto" != l ? (r[l] = c, "duration" == l ? r.end_date = t.calculateEndDate(r) : "end_date" == l ? r.start_date = t.calculateEndDate({
                                            ...
                                            duration: -r.duration,
                                            task: r
                                        }) : "start_date" == l && (r.end_date = t.calculateEndDate(r)), o.updateItem(e)) : this._editor.save(e, n.getColumn(i), this._placeholder), this.callEvent("onSave", [s])
                                    }
                                    this.hide()
                                }
                            } else this.hide()
                    ...
                    return c.mixin(s, e), c.mixin(s, i), s
                }
            };
        ...
        var n = i(2), r = i(1), a = i(0), o = i(13), s = function (t) {
            ...
            return n(e, t), e.prototype.init = function (t) {
                ...
                for (var t, e = 0, i = 0, n = this._isHorizontal(), r = this._getLinkedViews(), a = n ? "scrollWidth" : "scrollHeight", o = n ? "contentX" : "contentY", s = n ? "x" : "y", l = this._getScrollOffset(), c = 0; c < r.length; c++) if ((t = r[c]) && t.$content && t.$content.getSize && !t.$config.hidden) {
                    var u, d = t.$content.getSize();
                    if (u = d.hasOwnProperty(a) ? d[a] : d[o], l) d[o] > d[s] && d[o] > e && u > d[s] - l + 2 && (e = u + (n ? 0 : 2), i = d[s]); else {
                ...
                if (this._checkWheelTarget(e)) {
                    ...
                    var i = {}, n = o.isFF, r = n ? -20 * t.deltaX : 2 * t.wheelDeltaX,
        ...
        var n = i(2), r = i(26), a = i(7), o = function (t) {
            "use strict";
                ...
                createGroup: function (i, n, s) {
                    var l = {
                        tempCollection: [], renderers: {}, container: i, filters: [], getLayers: function () {
                            ...
                            for (var i = this.container(), o = this.tempCollection, s = 0; s < o.length; s++) if (t = o[s], this.container() || t && t.container && a.isChildOf(t.container, document.body)) {
                            ...
                            return t && ("function" == typeof t && (t = {renderer: t}), void 0 === t.filter ? t.filter = o(s || []) : t.filter instanceof Array && (t.filter.push(s), t.filter = o(t.filter)), t.container || (t.container = document.createElement("div"))), this._add(t), t ? t.id : void 0
            ...
            return {
                getDataRender: function (e) {
                    ...
                    var n = i.name, r = i.defaultContainer, a = i.defaultContainerSibling,
                        o = e.createGroup(r, a, function (t, e) {
                            if (!o.filters) return !0;
                            for (var i = 0; i < o.filters.length; i++) if (!1 === o.filters[i](t, e)) return !1
                        });
        ...
        var n = function (t) {
            return function (e) {
                ...
                function r(t) {
                    t = t || window.event;
                    var n = e.locate(t), r = o(t, i.click), a = !0;
                ...
                function o(e, i) {
                    for (var n = e.target || e.srcElement, r = []; n;) {
                        ...
                        if (a) {
                            a = a.split(" ");
                            for (var o = 0; o < a.length; o++) if (a[o] && i[a[o]]) for (var s = i[a[o]], l = 0; l < s.length; l++) s[l].root && !t.isChildOf(n, s[l].root) || r.push(s[l].handler)
                        }
                        n = n.parentNode
                    }
                    return r
                ...
                function l(t) {
                    t = t || window.event;
                    var n = e.locate(t), r = o(t, i.doubleclick),
                ...
                return {
                    reset: d, global: function (t, e, i) {
                        ...
                        var a = i[t][e];
                        if (a) for (var o = 0; o < a.length; o++) (n || a[o].root) && a[o].root !== n || a[o].handler.apply(this, r)
        ...
        var n = i(125), r = i(123), a = i(122), o = i(7), s = i(26), l = i(119), c = i(118), u = i(117), d = i(116),
            h = i(11), f = i(23), _ = i(23), g = i(11), p = i(11), v = i(113), m = i(22), y = i(104), b = i(103),
            k = i(102), w = i(101), x = i(100), $ = i(94), T = i(91);
        t.exports = {
            init: function (t) {
                function e(e, i) {
                    var n = i(t);
                ...
                i.registerView("cell", o), i.registerView("resizer", u), i.registerView("scrollbar", d), i.registerView("layout", s, function (t) {
                    "main" === (t.$config ? t.$config.id : null) && e(t, T)
                ...
                var S = a(t), C = v(t);
                return t.ext.inlineEditors = C, t.ext._inlineEditors = C, C.init(t), {
                    factory: i,
                    mouseEvents: r.init(t),
                    layersApi: S.init(),
                    render: {gridLine: w(t), taskBg: b(t), taskBar: m(t), taskSplitBar: y(t), link: k(t)},
                    layersService: {
                        getDataRender: function (e) {
        ...
        t.exports = function t(e, i) {
            ...
            return {
                attach: function (t, i, n, a) {
                    ...
                    i(t, e, n, a);
                    for (var o = 0; o < r.length; o++) (n = r[o]).element === t && n.event === e && n.callback === n && n.capture === a && (r.splice(o, 1), o--)
                }, detachAll: function () {
        ...
        (function (t) {
            ...
            }, i(129), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
        }).call(this, i(12))
    }, function (t, e, i) {
        (function (e, i, n) {
            t.exports = function () {
                    ...
                    1: [function (t, e, i) {
                        ...
                        e.exports = function (e, i, n, r) {
                            ...
                            e.prototype.break = e.prototype.cancel = function () {
                                ...
                                if (a.isArray(t)) for (var i = 0; i < t.length; ++i) this._doInvokeOnCancel(t[i], e); else if (void 0 !== t) if ("function" == typeof t) {
                                    if (!e) {
                        ...
                        "use strict";
                        e.exports = function (e) {
                            var i = t("./util"), n = t("./es5").keys, r = i.tryCatch, a = i.errorObj;
                        ...
                        e.exports = function (t) {
                            ...
                            return t.prototype._promiseCreated = function () {
                                ...
                                var i = t.prototype._pushContext, a = t.prototype._popContext, o = t._peekContext,
                        ...
                        i.exports = function (i, n) {
                            var r, a, o, s = i._getDomain, l = i._async, c = t("./errors").Warning, u = t("./util"),
                            ...
                            i.config = function (t) {
                                ...
                                if ("cancellation" in t && t.cancellation && !Z.cancellation) {
                                    ...
                                    i.prototype._clearCancellationData = M, i.prototype._propagateFrom = L, i.prototype._onCancel = P, i.prototype._setOnCancel = O, i.prototype._attachCancellationCallback = A, i.prototype._execute = I, N = L, Z.cancellation = !0
                                }
                            ...
                            function F(t, e, n) {
                                if (Z.warnings) {
                                    var r, a = new c(t);
                                    if (e) n._attachExtraTrace(a); else if (Z.longStackTraces && (r = i._peekContext())) r.attachExtraTrace(a); else {
                                        var o = V(a);
                                        a.stack = o.message + "\n" + o.stack.join("\n")
                                    }
                                    E("warning", a) || U(a, "", !0)
                            ...
                            function B(t) {
                                for (var e = [], i = 0; i < t.length; ++i) {
                                    var n = t[i], r = "    (No stack trace)" === n || p.test(n), a = r && q(n);
                            ...
                            function K(t) {
                                ...
                                Q(this, K), e > 32 && this.uncycle()
                            }

                            u.inherits(K, Error), n.CapturedTrace = K, K.prototype.uncycle = function () {
                                var t = this._length;
                                if (!(t < 2)) {
                                ...
                                if (!t.__stackCleaned__) {
                                    ...
                                    !function (t) {
                                        for (var e = t[0], i = 1; i < t.length; ++i) {
                                            for (var n = t[i], r = e.length - 1, a = e[r], o = -1, s = n.length - 1; s >= 0; --s) if (n[s] === a) {
                                                o = s;
                                                break
                                            }
                                            for (var s = o; s >= 0; --s) {
                            ...
                            var Z = {warnings: b, longStackTraces: !1, cancellation: !1, monitoring: !1};
                        ...
                        "use strict";
                        var n, r, a = t("./es5"), o = a.freeze, s = t("./util"), l = s.inherits,
                        ...
                        e.exports = function (e, i, n) {
                            var r = t("./util"), a = e.CancellationError, o = r.errorObj, s = t("./catch_filter")(n);
                        ...
                        e.exports = function (e, i, n, r, a, o) {
                            ...
                            c.inherits(f, a), f.prototype._isResolved = function () {
                                ...
                                if (!this._isResolved()) {
                                    ...
                                    if (i) this._promise._pushContext(), t = d(this._generator.return).call(this._generator, void 0), this._promise._popContext(); else {
                                ...
                                var i = Object(e).yieldHandler, n = f, r = (new Error).stack;
                                return function () {
                                    var e = t.apply(this, arguments), a = new n(void 0, void 0, i, r), o = a.promise();
                                ...
                                var n = new f(t, this), r = n.promise();
                        ...
                        e.exports = function (e, i, n, r, a, o) {
                            ...
                            l.inherits(h, i), h.prototype._asyncInit = function () {
                                ...
                                var n = this._values, a = this.length(), s = this._preservedValues, l = this._limit;
                                if (i < 0) {
                                    ...
                                    d._pushContext();
                                    var _ = c(h).call(f, t, i, a), g = d._popContext();
                        ...
                        e.exports = function (e, i, n, r, a) {
                            ...
                            e.method = function (t) {
                                ...
                                return function () {
                                    ...
                                    var r = s(t).apply(this, arguments), o = n._popContext();
                        ...
                        "use strict";
                        var n = t("./util"), r = n.maybeWrapAsError, a = t("./errors"), o = a.OperationalError,
                        ...
                        "use strict";
                        e.exports = function (e) {
                            var i = t("./util"), n = e._async, r = i.tryCatch, a = i.errorObj;
                        ...
                        i.exports = function () {
                            ...
                            var p = function () {
                                }, v = {}, m = {}, y = t("./thenables")(D, p), b = t("./promise_array")(D, p, y, a, o),
                                k = t("./context")(D), w = k.create, x = t("./debuggability")(D, k),
                            ...
                            return D.prototype.toString = function () {
                                ...
                                if (e > 1) {
                                    ...
                                    return n.length = r, t = arguments[i], this.then(void 0, T(n, t, this))
                                }
                                ...
                                var i = arguments.length > 1 && !!Object(arguments[1]).multiArgs, n = E(t)(S(e, i));
                                ...
                                t._bitField;
                                var e = t._fulfillmentHandler0, i = t._rejectionHandler0, n = t._promise0,
                                    r = t._receiverAt(0);
                                ...
                                var a = this._length();
                                if (a >= 65531 && (a = 0, this._setLength(0)), 0 === a) this._promise0 = i, this._receiver0 = n, "function" == typeof t && (this._fulfillmentHandler0 = null === r ? t : c.domainBind(r, t)), "function" == typeof e && (this._rejectionHandler0 = null === r ? e : c.domainBind(r, e)); else {
                                    var o = 4 * a - 4;
                                ...
                                if (0 == (65536 & r)) {
                                    var a;
                                    n._pushContext(), e === v ? i && "number" == typeof i.length ? a = E(t).apply(this._boundValue(), i) : (a = C).e = new _("cannot .spread() a non-array: " + c.classString(i)) : a = E(t).call(e, i);
                                    var o = n._popContext();
                                    0 == (65536 & (r = n._bitField)) && (a === m ? n._reject(i) : a === C ? n._rejectCallback(a.e, !1) : (x.checkForgottenReturns(a, o, "", n, this), n._resolveCallback(a)))
                                }
                            ...
                            }, c.notEnumerableProp(D, "_makeSelfResolutionError", n), t("./method")(D, p, y, a, x), t("./bind")(D, p, y, x), t("./cancel")(D, b, a, x), t("./direct_resolve")(D), t("./synchronous_inspection")(D), t("./join")(D, b, y, p, h, s), D.Promise = D, D.version = "3.5.4", t("./map.js")(D, b, a, y, p, x), t("./call_get.js")(D), t("./using.js")(D, a, y, w, p, x), t("./timers.js")(D, p, x), t("./generators.js")(D, a, p, y, o, x), t("./nodeify.js")(D), t("./promisify.js")(D, p), t("./props.js")(D, b, y, a), t("./race.js")(D, p, y, a), t("./reduce.js")(D, b, a, y, p, x), t("./settle.js")(D, b, x), t("./some.js")(D, b, a), t("./filter.js")(D, p), t("./each.js")(D, p), t("./any.js")(D), c.toFastProperties(D), c.toFastProperties(D.prototype), P({a: 1}), P({b: 2}), P({c: 3}), P(1), P(function () {
                            }), P(void 0), P(!1), P(new D(p)), x.setBounds(d.firstLineError, c.lastLineError), D
                        }
                    }, {
                        "./any.js": 1,
                        "./async": 2,
                        ...
                        e.exports = function (e, i) {
                            var n = {}, r = t("./util"), a = t("./nodeback"), o = r.withAppended,
                            ...
                            function p(t, e, i, n) {
                                for (var a = r.inheritedDataKeys(t), o = [], s = 0; s < a.length; ++s) {
                                    var l = a[s], u = t[l], d = n === h || h(l, u, t);
                                    "function" != typeof u || _(u) || g(t, l, e) || !n(l, u, t, d) || o.push(l, u)
                                }
                                return function (t, e, i) {
                                    for (var n = 0; n < t.length; n += 2) {
                                        var r = t[n];
                                        if (i.test(r)) for (var a = r.replace(i, ""), o = 0; o < t.length; o += 2) if (t[o] === a) throw new c("Cannot promisify an API that has normal methods with '%s'-suffix\n\n    See http://goo.gl/MqrFmX\n".replace("%s", e))
                                    }
                                }(o, e, i), o
                            }
                            ...
                            e.promisify = function (t, e) {
                                ...
                                if (_(t)) return t;
                                var i = void 0 === (e = Object(e)).context ? n : e.context, a = !!e.multiArgs,
                                    o = function (t, e, i) {
                        ...
                        e.exports = function (e, i, n, r) {
                            ...
                            function u(t) {
                                var e, i = !1;
                                if (void 0 !== a && t instanceof a) e = c(t), i = !0; else {
                            ...
                            o.inherits(u, i), u.prototype._init = function () {
                        ...
                        n.prototype._willBeOverCapacity = function (t) {
                            ...
                            this._capacity = t;
                            var i = this._front, n = this._length, r = i + n & e - 1;
                            !function (t, e, i, n, r) {
                        ...
                        e.exports = function (e, i, n, r, a, o) {
                            ...
                            l.inherits(u, i), u.prototype._gotAccum = function (t) {
                                ...
                                if (void 0 !== this._initialValue ? (i = this._initialValue, n = 0) : (i = e.resolve(t[0]), n = 1), this._currentCancellable = i, !i.isRejected()) for (; n < r; ++n) {
                                    var a = {accum: null, value: t[n], index: n, length: r, array: this};
                        ...
                        if (s.isNode && "undefined" == typeof MutationObserver) {
                            ...
                            var t = document.createElement("div"), e = {attributes: !0}, i = !1,
                                n = document.createElement("div"), r = new MutationObserver(function () {
                                    t.classList.toggle("foo"), i = !1
                                });
                            return r.observe(n, e), function (r) {
                        ...
                        "use strict";
                        e.exports = function (e, i) {
                            var n = t("./util"), r = n.errorObj, a = n.isObject, o = {}.hasOwnProperty;
                            return function (t, s) {
                                if (a(t)) {
                                    ...
                                    if ("function" == typeof l) {
                                        ...
                                        return function (t, a, o) {
                                            ...
                                            var c = !0, u = n.tryCatch(a).call(t, function (t) {
                        ...
                        e.exports = function (e, i, n, r, a, o) {
                            ...
                            g.prototype.data = function () {
                                ...
                                var k = e.all(b).then(function (t) {
                                    ...
                                    var n = l ? a.apply(void 0, t) : a(t), r = w._popContext();
                        ...
                        var b = function () {
                            ...
                            return function (i) {
                                if (e(i)) return [];
                                var r = [];
                                t:for (var a in i) if (n.call(i, a)) r.push(a); else {
                                    for (var o = 0; o < t.length; ++o) if (n.call(t[o], a)) continue t;
                                    r.push(a)
                                }
                                return r
                            }
                        ...
                        var j = void 0 !== e && "[object process]" === O(e).toLowerCase(),
        ...
        }).call(this, i(27), i(12), i(130).setImmediate)
    }, function (t, e, i) {
        t.exports = i(131)
    }, function (t, e, i) {
        var n = i(0);
        ...
        t.exports = function (t) {
            ...
            return i.prototype = {
                traceDragEvents: function (e, i) {
                    ...
                    if (t.config.touch) {
                        var r = n(i), a = r.target || r.srcElement, o = a.cloneNode(!0);
        ...
        t.exports = function (t) {
            var e = {
                init: function () {
                    ...
                    return e && !e.getFullYear && ("function" != typeof i && (i = "string" == typeof i ? t.defined(t.templates[i]) ? t.templates[i] : t.date.str_to_date(i) : t.templates.xml_date), e = e ? i(e) : null), e
                }
            };
            return e
        }
            ...
            return {
                cache: !0, method: "get", parse: function (t) {
                    ...
                    return new t.Promise(function (l, c) {
                        ...
                        }), "GET" != e || this.cache || (i += (i.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (new Date).getTime() + "=1"), u.open(e, i, a), s) for (var h in s) u.setRequestHeader(h, s[h]); else "POST" == e.toUpperCase() || "PUT" == e || "DELETE" == e ? u.setRequestHeader("Content-Type", "application/x-www-form-urlencoded") : "GET" == e && (r = null);
        ...
        t.exports = function () {
            var t = {};
            return {
                services: {config: "config", templates: "templates", locale: "locale"},
        ...
        i(15), t.exports = function () {
            var t = new function () {
                this.constants = i(142), this.version = "6.1.3", this.templates = {}, this.ext = {}, this.keys = {
                    edit_save: this.constants.KEY_CODES.ENTER,
                    edit_cancel: this.constants.KEY_CODES.ESC
                }
            };
            i(141)(t), t.$services = t.$inject(i(140)), t.config = t.$inject(i(139)), t.ajax = i(138)(t), t.date = i(136)(t);
            var e = i(135)(t);
            ...
            var a = i(0);
            a.mixin(t, a), t.Promise = i(132), t.env = i(13);
            var o = i(1);
            t.utils = {
                dom: {
            ...
            var s = i(128)();
            t.event = s.attach, t.eventRemove = s.detach, t._eventRemoveAll = s.detachAll, t._createDomEventScope = s.extend, a.mixin(t, i(127)(t));
            var l = i(126).init(t);
            ...
            }), t.mixin(t, l.layersApi), i(90)(t), t.$services.setService("layers", function () {
                return l.layersService
            });
            var c = i(89);
            t.mixin(t, c()), i(88)(t);
            var u = i(81);
            return t.dataProcessor = u.DEPRECATED_api, t.createDataProcessor = u.createDataProcessor, i(77)(t), i(68)(t), i(67)(t), i(66)(t), i(65)(t), i(64)(t), i(63)(t), i(54)(t), i(53)(t), i(44)(t), i(43)(t), i(42)(t), i(41)(t), i(40)(t), i(39)(t), i(38)(t), i(37)(t), i(36)(t), i(35)(t), i(34)(t), i(33)(t), i(32)(t), i(31)(t), i(29)(t), t
        }
    }, function (t, e) {
        t.exports = function (t) {
        }
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0});
        var n = i(144), r = i(143), a = window.gantt = r();
        e.gantt = a, n(a), e.default = a
    }])
});
