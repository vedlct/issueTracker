...
! function t(e, i, a) {
    ...
    7: [function(t, e, i) {
        ...
        t("./core/core.helpers")(a), t("./core/core.element")(a), t("./core/core.animation")(a), t("./core/core.controller")(a), t("./core/core.datasetController")(a), t("./core/core.layoutService")(a), t("./core/core.legend")(a), t("./core/core.plugin.js")(a), t("./core/core.scale")(a), t("./core/core.scaleService")(a), t("./core/core.title")(a), t("./core/core.tooltip")(a), t("./elements/element.arc")(a), t("./elements/element.line")(a), t("./elements/element.point")(a), t("./elements/element.rectangle")(a), t("./scales/scale.category")(a), t("./scales/scale.linear")(a), t("./scales/scale.logarithmic")(a), t("./scales/scale.radialLinear")(a), t("./scales/scale.time")(a), t("./controllers/controller.bar")(a), t("./controllers/controller.bubble")(a), t("./controllers/controller.doughnut")(a), t("./controllers/controller.timesheet")(a), t("./controllers/controller.milestone")(a), t("./controllers/controller.milestone")(a), t("./controllers/controller.line")(a), t("./controllers/controller.polarArea")(a), t("./controllers/controller.radar")(a), t("./charts/Chart.Bar")(a), t("./charts/Chart.Bubble")(a), t("./charts/Chart.Doughnut")(a), t("./charts/Chart.timesheet")(a), t("./charts/Chart.milestone")(a), t("./charts/Chart.milestone")(a), t("./charts/Chart.Line")(a), t("./charts/Chart.PolarArea")(a), t("./charts/Chart.Radar")(a), t("./charts/Chart.Scatter")(a), window.Chart = e.exports = a
    }, {
        "./charts/Chart.Bar": 8,
        "./charts/Chart.Bubble": 9,
        "./charts/Chart.Doughnut": 10,
        "./charts/Chart.timesheet": 53,
        "./charts/Chart.milestone": 51,
        ...
        "./controllers/controller.timesheet": 54,
        "./controllers/controller.milestone": 52,
    ...
    53: [function(t, e, i) {
        "use strict";
        e.exports = function(t) {
            t.timesheet = function(e, i) {
                return i.type = "timesheet", new t(e, i)
            }
        }
    }, {}],
    51: [function(t, e, i) {
        "use strict";
        e.exports = function(t) {
            t.milestone = function(e, i) {
                return i.type = "milestone", new t(e, i)
            }
        }
    }, {}],
    11: [function(t, e, i) {
    ...
    54: [function(t, e, i) {
        ...
        e.exports = function(t) {
            ...
            }, i.pie = e.clone(i.timesheet), e.extend(i.pie, {
                cutoutPercentage: 0
            }), t.controllers.timesheet = t.controllers.pie = t.DatasetController.extend({
                dataElementType: t.elements.Arc,
                linkScales: e.noop,
                getRingIndex: function(t) {
                    for (var e = 0, i = 0; t > i; ++i) this.chart.isDatasetVisible(i) && ++e;
    ...
    52: [function(t, e, i) {
        ...
        e.exports = function(t) {
            ...
            }, i.pie = e.clone(i.milestone), e.extend(i.pie, {
                cutoutPercentage: 0
            }), t.controllers.milestone = t.controllers.pie = t.DatasetController.extend({
                dataElementType: t.elements.Arc,
                linkScales: e.noop,
                getRingIndex: function(t) {
                    for (var e = 0, i = 0; t > i; ++i) this.chart.isDatasetVisible(i) && ++e;
